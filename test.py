...
# fn = field_ann.FieldANN(electrode_list)
...
fn = field_ann.FieldANN(electrode_list)
phi_axon = fn.field_ann(x_axon, y_axon, z_axon)

an = axon_ann.AxonANN(electrode_list, pulse_width, stimulation_amp, num_axons, axon_diameter)
axon_act = an.axon_ann(x_axon, y_axon, z_axon, lead_radius)
